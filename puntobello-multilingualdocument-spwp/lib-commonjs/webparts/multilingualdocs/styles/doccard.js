...
exports.cardLayoutStyles = void 0;
...
exports.cardLayoutStyles = (0, Styling_1.mergeStyleSets)({
    previewImageCss: {
        width: '100%',
    },
    listTitle: {
    ...
    cardTitle: {
        ...
        lineHeight: "".concat(rootEnv.css['--spfx_font_size_title'], "!important"),
        height: '48px',
        display: '-webkit-box',
    ...
    documentCardDate: {
        ...
        filter: "brightness(".concat(rootEnv.css['--spfx_color_grey_brightness_dark'], ")"),
    ...
    documentCardLinkListItem: {
        ...
        '&:hover': {
            ...
            filter: "brightness(".concat(rootEnv.css['--spfx_color_primary_brightness_dark'], ")")
        },
    },
});
